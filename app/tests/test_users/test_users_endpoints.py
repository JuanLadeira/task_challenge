...
@pytest.mark.users
def test_get_user_by_id(client: TestClient, user_factory, token):
    """
...
@pytest.mark.users
def test_get_user_by_id_not_found(client: TestClient, token):
    """
...
def test_delete_user(client: TestClient, user_factory, token):
    """
